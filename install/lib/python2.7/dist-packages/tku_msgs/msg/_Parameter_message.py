...
class Parameter_message(genpy.Message):
  _md5sum = "0ff3428b87b449995d8490e48a39ea2e"
...
float32 Support_Foot_Ankle_Upper_Pitch"""
  __slots__ = ['Walking_Mode','X_Swing_Range','Y_Swing_Range','Z_Swing_Range','Period_T','Period_T2','Sample_Time','OSC_LockRange','BASE_Default_Z','Y_Swing_Shift','X_Swing_COM','BASE_LIFT_Z','B_SplineParam']
  _slot_types = ['int32','float64','float64','float64','int32','int32','int32','float64','float64','int32','int32','int32','tku_msgs/B_SplineParam']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       Walking_Mode,X_Swing_Range,Y_Swing_Range,Z_Swing_Range,Period_T,Period_T2,Sample_Time,OSC_LockRange,BASE_Default_Z,Y_Swing_Shift,X_Swing_COM,BASE_LIFT_Z,B_SplineParam
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_i3d3i2d3i8f = None
def _get_struct_i3d3i2d3i8f():
    global _struct_i3d3i2d3i8f
    if _struct_i3d3i2d3i8f is None:
        _struct_i3d3i2d3i8f = struct.Struct("<i3d3i2d3i8f")
    return _struct_i3d3i2d3i8f
