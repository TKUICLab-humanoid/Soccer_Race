...
"""autogenerated by genpy from tku_msgs/Distance.msg. Do not edit."""
import codecs
import sys
...
class Distance(genpy.Message):
  _md5sum = "3321358cdd898a39621fbe77e10211cf"
  _type = "tku_msgs/Distance"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int16 x_dis
int16 y_dis
int16 dis
"""
  __slots__ = ['x_dis','y_dis','dis']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.x_dis is None:
        self.x_dis = 0
      if self.y_dis is None:
        self.y_dis = 0
      if self.dis is None:
        self.dis = 0
    else:
