...
class HeadStrategy
{
    public:
        ...
        TimeClass timer_trace_soccer;
        //----------------

        bool able_head_classify;
        bool check_time_flag;
        ...
        void headStrategy(bool &soccer_flag, int &soccer_info_x, int &soccer_info_y, bool able_move_head = true);

        void goalCheck(bool finish_flag = false, bool side_decide = false);
