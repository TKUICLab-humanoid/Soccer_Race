...
void Wstrategy::Init()
{
    ...
    m_state = P_TRACK;
    publishparam(continous_x,continous_y,continous_angle);
}
...
void Wstrategy::Track()
{
    if(strategy_info->getRobotPosition().x > 0 && strategy_info->getRobotPosition().y > 0)
    {
        ...
        tool->Delay(300);
		publishparam(continous_x,0,continous_angle);
    }
}

void Wstrategy::publishparam(int continous_x,int continous_y, int continous_angle)
{
